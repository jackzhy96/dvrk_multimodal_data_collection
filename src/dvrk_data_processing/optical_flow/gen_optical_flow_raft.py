"""
Stage-4 default optical flow pipeline — RAFT (torchvision).

Reads consecutive rectified frame pairs out of ``intermediate_dir/image/<cam>/``
and writes the dense forward flow (``frame[i] → frame[i+1]``) to
