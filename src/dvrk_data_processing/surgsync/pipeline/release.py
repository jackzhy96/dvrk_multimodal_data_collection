...
def _render_readme(inv: _ReleaseInventory, dataset_root: Path) -> str:
    ...
    L.append("")
    L.append("- `HOW_to_RUN.md` — single-page runbook (preprocessing + packing + unpacking).")
    L.append("- `HOW_to_RUN_pack.md` — full `surgsync build` reference with every flag.")
    L.append("- `HOW_to_RUN_unpack.md` — `surgsync unpack` reference + fidelity table.")
    L.append("- `HOW_to_RUN_Process.md` — preprocessing-stage operator guide.")
