...
void loop() {
  ...
  long value1 = psm1Sensor.capacitiveSensor(30);
  long value2 = psm2Sensor.capacitiveSensor(30);
  long value3 = psm3Sensor.capacitiveSensor(30);
  ...
  // Serial.print(digitalRead(PSM1_PIN));                  
  // Serial.print("\t");                    
  // Serial.print(digitalRead(PSM2_PIN));                  
  // Serial.print("\t");                    
  // Serial.println(digitalRead(PSM3_PIN));
